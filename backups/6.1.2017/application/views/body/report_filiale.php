    ...
    <div style="clear:both;">
        <div style="float:left;width:90%">
            ...
            <div class="container2" style="width:100%">
                ...
                <h2 style="border-bottom: 1px solid #666666; padding-bottom: 3px; background: url(../images/tpl/suchen-icon.png) 0 -5px no-repeat;">Jahresbericht</h2><br>
                        ...
                        <?php
                            if(isset($records) && !empty($records)){
                                foreach($records as $firma){
                                    ...
                                    @$row .= "<tr><td>$date</td><td>". htmlspecialchars($firma_name) . "</td><td>$single_count</td><td>$familie</td><td>$personen_3</td>
