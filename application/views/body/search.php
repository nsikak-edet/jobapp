        ...
        <div style="float:left;width:90%">
            <style>
                ...
                <div class="container2" style="">
                    ...
                    <h2 style="border-bottom: 1px solid #666666; padding-bottom: 10px; background: url(../images/tpl/suchen-icon.png) 0 -5px no-repeat;">Bericht erstellen <a href="<?php echo base_url() ?>index.php/app/pdf/be">(Druckfassung A4)</a></h2>
                    ...
                    <form method="post" name="suchen" id="suchen1" action="" width="100%">
                        <table border="0" cellpadding="2" cellspacing="0" >
                            <tr>
                                ...
                                <td><select name="company" style="width:250px;" class="hersteller">
                                        ...
                                        if(!empty($companies)){
                                            ...
                                            {
                                                $id = (int)$company->id;
                                                $name = $company->name;//iconv('UTF-8', 'ISO-8859-1', htmlspecialchars($company->name));
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td><input type="submit" name="save_data" value="Bericht generieren" /> &nbsp; </td>
                            </tr>
                        </table><br />
                    </form>
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        if(isset($invitations) && !empty($invitations)){
                            foreach($invitations as $invitation){
                                ...
                                $CI->session->set_userdata('pdf_report_firma',$company);
                                ...
                                @$row .= "<tr><td>$date</td><td>$consultant</td><td>$customer_name</td><td>$single</td>
                            ...
                            if(@$count > 0){
                                @$row = "<tr><td>Summe</td><td></td><td></td><td>$singletotal</td>
                    ...
                    $table = $CI->template->getPDFTemplate('pdf/bericht.php',@$all_rows);
                    $CI->pdfgenerator->generatePDF(BE_FILENAME,$table);
                    ?>
