    ...
    <div style="clear:both;">
        <div style="float:left;width:90%">
            ...
            <div class="container2" style="width:100%">
                ...
                <h2 style="border-bottom: 1px solid #666666; padding-bottom: 3px; background: url(../images/tpl/suchen-icon.png) 0 -5px no-repeat;">Jahresbericht | <a href="<?php echo base_url() ?>index.php/app/pdf">(Druckfassung A4)</a></h2><br>
                    ...
                    <table id="example" class="order-column cell-border compact hover" cellspacing="0" width="100%">
                        ...
                        <?php
                            if(isset($records) && !empty($records)){
                                ...
                                @$row .= "<tr style='color:red'><td>zz--Summe--zz</td><td>".@$singletotal."</td><td>".@$familie_total ."</td><td>".@$personen_3_total."</td>
                                               <td>".@$personen_4_total."</td><td>".@$ekarten_total."</td><td>".@$familie_value_total."</td><td>".@$personen_3_value_total."</td>
                                               <td>".@$personen_4_value_total."</td><td>".@$sumtotal."</td><td>".@$mwst_total."</td><td>".@$netto_total."</td></tr>";
                                echo @$row;
                            }
                        ?>
                        </tbody>
                ...
                <?php
                        ...
                        $table = $CI->template->getPDFTemplate('pdf/jahresbericht.php',$row);
                        $CI->pdfgenerator->generatePDF(JAHR_FILENAME,$table);
                ...
                $(document).ready(function() {
                   ...
                   $('#example').DataTable({
                       ...
                       language: {
                        ...
                        // Update footer
//                        $( api.column(7).footer() ).html(fKarten);
//                            $( api.column(2).footer() ).html(singleSum);
//                            $( api.column(3).footer() ).html(familieSum);
//                            $( api.column(4).footer() ).html(p3);
//                            $( api.column(5).footer() ).html(p4);
//                            $( api.column(6).footer() ).html(eKarten);
//                            $( api.column(8).footer() ).html(p3v);
//                            $( api.column(9).footer() ).html(p4v);
//                            $( api.column(10).footer() ).html(sum);
//                            $( api.column(11).footer() ).html(mwst);
//                            $( api.column(12).footer() ).html(netto);
                    }
                    });
                } );
            </script>
