            ...
            <div class="container2" style="width:100%">
                ...
                <form method="get" name="suchen" id="suchen1" action="" width="100%">
                    <table border="0" cellpadding="2" cellspacing="0" >
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td><input type="submit" name="get_report" value="Bericht generieren" /> &nbsp; </td>
                        </tr>
                    </table><br />
                </form>
                    ...
                    <table id="example" class="order-column cell-border compact hover" cellspacing="0" width="100%">
                        ...
                        <?php
                            if(isset($records) && !empty($records)){
                                ...
                                @$row .= "<tr style='color:red'><td>Summe</td><td></td><td></td><td>".@$singletotal ."</td><td>".@$familie_total."</td>
                                               <td>".@$personen_3_total."</td><td>".@$personen_4_total."</td></tr>";
