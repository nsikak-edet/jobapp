...
<div class="wrapper">
    <div class="header">
        ...
        ?>
        <a href="http://www.fertighauswelt.de/"><img src="<?php echo getAssetsURL(); ?>/images/logo/<?php echo $logo_file_name; ?>" alt="Fertighaus Welt" /></a>
        ...
        <div id="mainmenue">
            ...
            <a href="<?php echo base_url() ?>index.php/app/help" title="<?php echo convertToUTF8("Hilfe"); ?>" class="subnav" ><?php echo convertToUTF8("Hilfe"); ?></a>
